...
/* Better sidebar look */
[data-testid="stSidebar"] {
    background: linear-gradient(180deg, rgba(11, 18, 32, 0.98), rgba(17, 24, 39, 0.96)) !important;
...
.hero-card {
    ...
    border-radius: 24px;
    background:
        radial-gradient(circle at 18% 25%, rgba(59, 130, 246, 0.13), transparent 35%),
...
/* Inputs look like dashboard fields */
...
/* Keep right tips panel above background */
.right-tips-panel {
